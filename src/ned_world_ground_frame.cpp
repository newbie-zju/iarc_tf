...
ned_world_ground::NedWorldGroundFrame::NedWorldGroundFrame(ros::NodeHandle nh)
{
...
void ned_world_ground::NedWorldGroundFrame::positionCallback(const dji_sdk::LocalPositionConstPtr& msg)
{
    ...
    transformState =listener.waitForTransform("/body","/ground",ros::Time(0),ros::Duration(10.0));
